...
$choice = arg(0).'/'.arg(1);
$pic_path = 'sites/default/files/kidsimages/';
$id = 1;
...
$result = db_query("SELECT * from kids_images WHERE kid = '$id'");
...
<div class="subpage-content-container">
        ...
        <!-- Pic Box-->
         <div class="rightbox">
         <div class="imgBox">
         <div class="img"><img src="<?php print $pic_path.$row->filename1 ?>" width="200" height="163" alt="Child Images" /></div>
         <div class="heading"><?php print l($row->linktitle1, $row->linkpath1) ?></div>
         </div>
         <div class="imgBox">
         <div class="img"><img src="<?php print $pic_path.$row->filename2 ?>" width="200" height="163" alt="Child Arts" /></div>
         <div class="heading"><?php print l($row->linktitle2, $row->linkpath2) ?></div>
         </div>
         </div>  
        <!-- Ends Pic Boxs-->
